...
#define GPIO_7_SEG_PORT                  GPIOC


void PowerOn_7_SEG(void) {
    GPIO_7_SEG_PORT->BRR |= GPIO_7_SEG_POWER_PIN;
}

void PowerOff_7_SEG(void) {
    GPIO_7_SEG_PORT->BSRR |= GPIO_7_SEG_POWER_PIN;
}


void On_7_SEG_OnePin(uint16_t pinNum) {
    GPIO_7_SEG_PORT->BRR |= pinNum;
}

void Off_7_SEG_OnePin(uint16_t pinNum) {
    GPIO_7_SEG_PORT->BSRR |= pinNum;
}
...
void Seven_Segment_Test(void)
{
    ...
    GPIO_Init(GPIO_7_SEG_PORT, &GPIO_InitStructure);
